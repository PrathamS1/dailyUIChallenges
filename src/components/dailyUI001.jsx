  ...
  const features = [
    {
      ...
      description:
        "Automatically generate production-ready code based on your requirements and specifications.",
      image: "/smart.png",
    },
    {
      id: 2,
      ...
      description:
        "Development lifecycle automation with zero manual intervention.",
      image: "/work.png",
    },
    {
      id: 3,
      ...
      description:
        "Real-time documentation generation that stays synchronized with your codebase changes.",
      image: "/docs.png",
    },
    {
      id: 4,
      ...
      description:
        "Detailed analytics and progress tracking with predictive timeline estimates.",
      image: "/track.png",
    },
  ];
          ...
          >
            <div className="text-center">
              ...
              <p className="text-zinc-600 mb-6">
                You're now on the early access list. We'll notify you when your
                account is ready.
              </p>
            ...
            <div className="container mx-auto max-w-4xl">
              ...
              >
                ...
                <motion.div variants={itemVariants} className="space-y-6">
                  ...
                  <p className="text-xl text-zinc-800 max-w-4xl mx-auto leading-relaxed">
                    Tell FlowAI what you want to build, and watch as it
                    automates your entire development workflow from planning to
                    deployment with intelligent documentation and progress
                    tracking.
                  </p>
                </motion.div>
                      ...
                      >
                        <div className="mb-6 text-center">
                          ...
                          <p className="text-zinc-600">
                            Complete your early access registration
                          </p>
                        </div>
                ...
                <motion.div
                  variants={itemVariants}
                  className="flex items-center justify-center space-x-6 text-sm text-zinc-500"
                >
          ...
          <div className="container mx-auto">
            ...
            >
              ...
              <p className="text-xl text-zinc-600 max-w-2xl mx-auto">
                From initial concept to production deployment, FlowAI handles
                ...
                >
                  ...
                  >
                              ...
                              {feature.id === 1 && (
                                <>
                                  ...
                                  <li className="flex items-center space-x-2">
                                    <Check className="w-4 h-4 text-green-600 flex-shrink-0" />
                                    <span>
                                      Multi-language support (React, Python,
                                      Node.js)
                                    </span>
                                  </li>
                                  <li className="flex items-center space-x-2">
                    ...
                    >
                      ...
                      <motion.div
                        animate={{
                          rotate: expandedFeature === feature.id ? 90 : 0,
                        }}
          ...
          <div className="container mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-zinc-300 mb-8">
                Watch how FlowAI transforms a simple idea into a complete
                development lifecycle in minutes.
              </p>
